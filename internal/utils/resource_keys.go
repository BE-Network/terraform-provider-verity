...
var ResourceJSONKeys = map[string]string{
	...
	"device_aaa_profile":       "device_aaa_profile",
...
var ImporterResourceMapping = map[string]string{
	...
	"deviceaaaprofiles":       "device_aaa_profile",
	"ldapprofiles":            "ldap_profile",
	...
	"sspgroups":               "superspine_group",
	"sus":                     "su",
	"policybasedroutingacl":   "pb_routing_acl",
	"tacacsprofiles":          "tacacs_profile",
