...
var ResourceCompatibility = map[string]ResourceMode{
	...
	"verity_as_path_access_list":      ResourceModeBoth,
	"verity_badge":                    ResourceModeBoth,
	"verity_bundle":                   ResourceModeBoth,
	"verity_community_list":           ResourceModeBoth,
	...
	"verity_extended_community_list":  ResourceModeBoth,
	"verity_ipv4_list":                ResourceModeBoth,
	"verity_ipv4_prefix_list":         ResourceModeBoth,
	"verity_ipv6_list":                ResourceModeBoth,
	"verity_ipv6_prefix_list":         ResourceModeBoth,
	"verity_lag":                      ResourceModeBoth,
	"verity_packet_broker":            ResourceModeBoth,
