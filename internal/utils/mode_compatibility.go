...
var ResourceCompatibility = map[string]ResourceMode{
	...
	"verity_service":           ResourceModeDatacenter,
	"verity_eth_port_profile":  ResourceModeDatacenter,
	"verity_eth_port_settings": ResourceModeDatacenter,
	"verity_lag":               ResourceModeDatacenter,
	"verity_bundle":            ResourceModeDatacenter,
}
