...
func (i *Importer) generateStagesTF() (string, error) {
	...
	if i.Mode == "campus" {
		stageOrder = []StageDefinition{
			...
			{"ipv4_list_stage", "verity_ipv4_list", "sfp_breakout_stage"},
			{"ipv6_list_stage", "verity_ipv6_list", "ipv4_list_stage"},
			{"acl_v6_stage", "verity_acl_v6", "ipv6_list_stage"},
			{"acl_v4_stage", "verity_acl_v4", "acl_v6_stage"},
			{"service_stage", "verity_service", "acl_v4_stage"},
			{"port_acl_stage", "verity_port_acl", "service_stage"},
			{"mac_filter_stage", "verity_mac_filter", "port_acl_stage"},
			{"ldap_profile_stage", "verity_ldap_profile", "mac_filter_stage"},
			{"tacacs_profile_stage", "verity_tacacs_profile", "ldap_profile_stage"},
			{"service_port_profile_stage", "verity_service_port_profile", "tacacs_profile_stage"},
			{"fabric_stage", "verity_fabric", "service_port_profile_stage"},
			{"eth_port_profile_stage", "verity_eth_port_profile", "fabric_stage"},
			{"device_aaa_profile_stage", "verity_aaa_profile", "eth_port_profile_stage"},
			{"packet_queue_stage", "verity_packet_queue", "device_aaa_profile_stage"},
			{"sflow_collector_stage", "verity_sflow_collector", "packet_queue_stage"},
			{"diagnostics_port_profile_stage", "verity_diagnostics_port_profile", "sflow_collector_stage"},
			{"lag_stage", "verity_lag", "diagnostics_port_profile_stage"},
			{"voice_port_profile_stage", "verity_voice_port_profile", "lag_stage"},
			{"device_settings_stage", "verity_device_settings", "voice_port_profile_stage"},
			{"eth_port_settings_stage", "verity_eth_port_settings", "device_settings_stage"},
			{"authenticated_eth_port_stage", "verity_authenticated_eth_port", "eth_port_settings_stage"},
			{"device_voice_setting_stage", "verity_device_voice_settings", "authenticated_eth_port_stage"},
			{"diagnostics_profile_stage", "verity_diagnostics_profile", "device_voice_setting_stage"},
			{"bundle_stage", "verity_bundle", "diagnostics_profile_stage"},
			{"badge_stage", "verity_badge", "bundle_stage"},
			{"switchpoint_stage", "verity_switchpoint", "badge_stage"},
			{"grouping_rule_stage", "verity_grouping_rule", "switchpoint_stage"},
			{"threshold_stage", "verity_threshold", "grouping_rule_stage"},
		...
		stageOrder = []StageDefinition{
			{"sfp_breakout_stage", "verity_sfp_breakout", ""},
			{"extended_community_list_stage", "verity_extended_community_list", "sfp_breakout_stage"},
			{"ipv6_prefix_list_stage", "verity_ipv6_prefix_list", "extended_community_list_stage"},
			...
			{"ipv4_prefix_list_stage", "verity_ipv4_prefix_list", "as_path_access_list_stage"},
			{"route_map_clause_stage", "verity_route_map_clause", "ipv4_prefix_list_stage"},
			{"acl_v4_stage", "verity_acl_v4", "route_map_clause_stage"},
			{"acl_v6_stage", "verity_acl_v6", "acl_v4_stage"},
			{"route_map_stage", "verity_route_map", "acl_v6_stage"},
			...
			{"ldap_profile_stage", "verity_ldap_profile", "service_stage"},
			{"tacacs_profile_stage", "verity_tacacs_profile", "ldap_profile_stage"},
			{"ipv6_list_stage", "verity_ipv6_list", "tacacs_profile_stage"},
			{"ipv4_list_stage", "verity_ipv4_list", "ipv6_list_stage"},
			{"port_acl_stage", "verity_port_acl", "ipv4_list_stage"},
			{"fabric_stage", "verity_fabric", "port_acl_stage"},
			{"packet_queue_stage", "verity_packet_queue", "fabric_stage"},
			{"device_aaa_profile_stage", "verity_aaa_profile", "packet_queue_stage"},
			{"sflow_collector_stage", "verity_sflow_collector", "device_aaa_profile_stage"},
			{"packet_broker_stage", "verity_packet_broker", "sflow_collector_stage"},
			{"eth_port_profile_stage", "verity_eth_port_profile", "packet_broker_stage"},
			{"gateway_stage", "verity_gateway", "eth_port_profile_stage"},
			{"pod_stage", "verity_pod", "gateway_stage"},
			{"diagnostics_port_profile_stage", "verity_diagnostics_port_profile", "pod_stage"},
			{"device_settings_stage", "verity_device_settings", "diagnostics_port_profile_stage"},
			{"diagnostics_profile_stage", "verity_diagnostics_profile", "device_settings_stage"},
			{"eth_port_settings_stage", "verity_eth_port_settings", "diagnostics_profile_stage"},
			{"lag_stage", "verity_lag", "eth_port_settings_stage"},
			{"gateway_profile_stage", "verity_gateway_profile", "lag_stage"},
			{"su_stage", "verity_su", "gateway_profile_stage"},
			{"plane_stage", "verity_plane", "su_stage"},
			{"bundle_stage", "verity_bundle", "plane_stage"},
			{"ssp_group_stage", "verity_ssp_group", "bundle_stage"},
			{"badge_stage", "verity_badge", "ssp_group_stage"},
			{"rack_stage", "verity_rack", "badge_stage"},
			{"spine_plane_stage", "verity_spine_plane", "rack_stage"},
