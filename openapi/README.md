...
*LDAPProfilesAPI* | [**LdapprofilesDelete**](docs/LDAPProfilesAPI.md#ldapprofilesdelete) | **Delete** /ldapprofiles | Delete LDAP Profile
*LDAPProfilesAPI* | [**LdapprofilesGet**](docs/LDAPProfilesAPI.md#ldapprofilesget) | **Get** /ldapprofiles | Get all LDAP Profiles
*LDAPProfilesAPI* | [**LdapprofilesPatch**](docs/LDAPProfilesAPI.md#ldapprofilespatch) | **Patch** /ldapprofiles | Update LDAP Profile
*LDAPProfilesAPI* | [**LdapprofilesPut**](docs/LDAPProfilesAPI.md#ldapprofilesput) | **Put** /ldapprofiles | Create LDAP Profile
*MACFiltersAPI* | [**MacfiltersDelete**](docs/MACFiltersAPI.md#macfiltersdelete) | **Delete** /macfilters | Delete MAC Filter
*MACFiltersAPI* | [**MacfiltersGet**](docs/MACFiltersAPI.md#macfiltersget) | **Get** /macfilters | Get all MAC Filters
*MACFiltersAPI* | [**MacfiltersPatch**](docs/MACFiltersAPI.md#macfilterspatch) | **Patch** /macfilters | Update MAC Filter
*MACFiltersAPI* | [**MacfiltersPut**](docs/MACFiltersAPI.md#macfiltersput) | **Put** /macfilters | Create MAC Filter
...
*SUsAPI* | [**SusDelete**](docs/SUsAPI.md#susdelete) | **Delete** /sus | Delete SU
*SUsAPI* | [**SusGet**](docs/SUsAPI.md#susget) | **Get** /sus | Get all SUs
*SUsAPI* | [**SusPatch**](docs/SUsAPI.md#suspatch) | **Patch** /sus | Update SU
*SUsAPI* | [**SusPut**](docs/SUsAPI.md#susput) | **Put** /sus | Create SU
...
*SuperSpineGroupsAPI* | [**SspgroupsDelete**](docs/SuperSpineGroupsAPI.md#sspgroupsdelete) | **Delete** /sspgroups | Delete SuperSpine Group
*SuperSpineGroupsAPI* | [**SspgroupsGet**](docs/SuperSpineGroupsAPI.md#sspgroupsget) | **Get** /sspgroups | Get all SuperSpine Groups
*SuperSpineGroupsAPI* | [**SspgroupsPatch**](docs/SuperSpineGroupsAPI.md#sspgroupspatch) | **Patch** /sspgroups | Update SuperSpine Group
*SuperSpineGroupsAPI* | [**SspgroupsPut**](docs/SuperSpineGroupsAPI.md#sspgroupsput) | **Put** /sspgroups | Create SuperSpine Group
*SwitchPairsAPI* | [**PairsDelete**](docs/SwitchPairsAPI.md#pairsdelete) | **Delete** /pairs | Delete Switch Pair
*SwitchPairsAPI* | [**PairsGet**](docs/SwitchPairsAPI.md#pairsget) | **Get** /pairs | Get all Switch Pairs
*SwitchPairsAPI* | [**PairsPatch**](docs/SwitchPairsAPI.md#pairspatch) | **Patch** /pairs | Update Switch Pair
*SwitchPairsAPI* | [**PairsPut**](docs/SwitchPairsAPI.md#pairsput) | **Put** /pairs | Create Switch Pair
...
## Documentation For Models
 ...
 - [LagsPutRequestLagValueObjectProperties](docs/LagsPutRequestLagValueObjectProperties.md)
 - [LdapprofilesPutRequest](docs/LdapprofilesPutRequest.md)
 - [LdapprofilesPutRequestLdapProfileValue](docs/LdapprofilesPutRequestLdapProfileValue.md)
 - [LdapprofilesPutRequestLdapProfileValueAttributeMapsInner](docs/LdapprofilesPutRequestLdapProfileValueAttributeMapsInner.md)
 - [LdapprofilesPutRequestLdapProfileValueLdapServersInner](docs/LdapprofilesPutRequestLdapProfileValueLdapServersInner.md)
 - [MacfiltersPutRequest](docs/MacfiltersPutRequest.md)
 - [MacfiltersPutRequestMacFilterValue](docs/MacfiltersPutRequestMacFilterValue.md)
 - [MacfiltersPutRequestMacFilterValueFiltersInner](docs/MacfiltersPutRequestMacFilterValueFiltersInner.md)
 ...
 - [SspgroupsPutRequestSuperspineGroupValue](docs/SspgroupsPutRequestSuperspineGroupValue.md)
 - [SusPutRequest](docs/SusPutRequest.md)
 - [SusPutRequestSuValue](docs/SusPutRequestSuValue.md)
