...
// checks if the SwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner{}
...
type NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner struct {
	value *SwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner
	isSet bool
}

func (v NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) Get() *SwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner {
	return v.value
}

func (v *NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) Set(val *SwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner(val *SwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) *NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner {
	return &NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner{value: val, isSet: true}
}

func (v NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwitchpointsPutRequestSwitchpointValueTrafficMirrorsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
