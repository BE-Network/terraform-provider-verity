...
// checks if the ConfigPutRequestCommunityListCommunityListName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigPutRequestCommunityListCommunityListName{}

// ConfigPutRequestCommunityListCommunityListName struct for ConfigPutRequestCommunityListCommunityListName
type ConfigPutRequestCommunityListCommunityListName struct {
	...
	Lists []ConfigPutRequestCommunityListCommunityListNameListsInner `json:"lists,omitempty"`
...
func NewConfigPutRequestCommunityListCommunityListName() *ConfigPutRequestCommunityListCommunityListName {
	this := ConfigPutRequestCommunityListCommunityListName{}
	var name string = ""
	this.Name = &name
...
func (o *ConfigPutRequestCommunityListCommunityListName) GetLists() []ConfigPutRequestCommunityListCommunityListNameListsInner {
	if o == nil || IsNil(o.Lists) {
		var ret []ConfigPutRequestCommunityListCommunityListNameListsInner
		return ret
	}
	return o.Lists
}
...
// SetLists gets a reference to the given []ConfigPutRequestCommunityListCommunityListNameListsInner and assigns it to the Lists field.
...
func (o ConfigPutRequestCommunityListCommunityListName) MarshalJSON() ([]byte, error) {
...
func (o ConfigPutRequestCommunityListCommunityListName) ToMap() (map[string]interface{}, error) {
...
type NullableConfigPutRequestCommunityListCommunityListName struct {
	value *ConfigPutRequestCommunityListCommunityListName
	isSet bool
}

func (v NullableConfigPutRequestCommunityListCommunityListName) Get() *ConfigPutRequestCommunityListCommunityListName {
	return v.value
}

func (v *NullableConfigPutRequestCommunityListCommunityListName) Set(val *ConfigPutRequestCommunityListCommunityListName) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigPutRequestCommunityListCommunityListName) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigPutRequestCommunityListCommunityListName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigPutRequestCommunityListCommunityListName(val *ConfigPutRequestCommunityListCommunityListName) *NullableConfigPutRequestCommunityListCommunityListName {
	return &NullableConfigPutRequestCommunityListCommunityListName{value: val, isSet: true}
}

func (v NullableConfigPutRequestCommunityListCommunityListName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigPutRequestCommunityListCommunityListName) UnmarshalJSON(src []byte) error {
	v.isSet = true
