...
// checks if the ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner{}

// ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner struct for ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner
type ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner struct {
	// Enable
...
func NewConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner() *ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner {
	this := ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner{}
...
func (o ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) MarshalJSON() ([]byte, error) {
...
func (o ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) ToMap() (map[string]interface{}, error) {
...
type NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner struct {
	value *ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner
	isSet bool
}

func (v NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) Get() *ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner {
	return v.value
}

func (v *NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) Set(val *ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner(val *ConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) *NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner {
	return &NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner{value: val, isSet: true}
}

func (v NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigPutRequestPbEgressProfilePbEgressProfileNameIpv6PermitInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
