...
// checks if the GatewaysPutRequestGatewayValueStaticRoutesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewaysPutRequestGatewayValueStaticRoutesInner{}
...
func NewGatewaysPutRequestGatewayValueStaticRoutesInner() *GatewaysPutRequestGatewayValueStaticRoutesInner {
	this := GatewaysPutRequestGatewayValueStaticRoutesInner{}
...
type NullableGatewaysPutRequestGatewayValueStaticRoutesInner struct {
	value *GatewaysPutRequestGatewayValueStaticRoutesInner
	isSet bool
}

func (v NullableGatewaysPutRequestGatewayValueStaticRoutesInner) Get() *GatewaysPutRequestGatewayValueStaticRoutesInner {
	return v.value
}

func (v *NullableGatewaysPutRequestGatewayValueStaticRoutesInner) Set(val *GatewaysPutRequestGatewayValueStaticRoutesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewaysPutRequestGatewayValueStaticRoutesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewaysPutRequestGatewayValueStaticRoutesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewaysPutRequestGatewayValueStaticRoutesInner(val *GatewaysPutRequestGatewayValueStaticRoutesInner) *NullableGatewaysPutRequestGatewayValueStaticRoutesInner {
	return &NullableGatewaysPutRequestGatewayValueStaticRoutesInner{value: val, isSet: true}
}

func (v NullableGatewaysPutRequestGatewayValueStaticRoutesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewaysPutRequestGatewayValueStaticRoutesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
