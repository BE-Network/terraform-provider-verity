...
// checks if the SwitchpointsPutRequestEndpointValueObjectProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwitchpointsPutRequestEndpointValueObjectProperties{}

// SwitchpointsPutRequestEndpointValueObjectProperties struct for SwitchpointsPutRequestEndpointValueObjectProperties
type SwitchpointsPutRequestEndpointValueObjectProperties struct {
...
func NewSwitchpointsPutRequestEndpointValueObjectProperties() *SwitchpointsPutRequestEndpointValueObjectProperties {
	this := SwitchpointsPutRequestEndpointValueObjectProperties{}
...
func (o *SwitchpointsPutRequestEndpointValueObjectProperties) SetNumberOfMultipointsNil() {
...
func (o SwitchpointsPutRequestEndpointValueObjectProperties) MarshalJSON() ([]byte, error) {
...
func (o SwitchpointsPutRequestEndpointValueObjectProperties) ToMap() (map[string]interface{}, error) {
...
type NullableSwitchpointsPutRequestEndpointValueObjectProperties struct {
	value *SwitchpointsPutRequestEndpointValueObjectProperties
	isSet bool
}

func (v NullableSwitchpointsPutRequestEndpointValueObjectProperties) Get() *SwitchpointsPutRequestEndpointValueObjectProperties {
	return v.value
}

func (v *NullableSwitchpointsPutRequestEndpointValueObjectProperties) Set(val *SwitchpointsPutRequestEndpointValueObjectProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableSwitchpointsPutRequestEndpointValueObjectProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableSwitchpointsPutRequestEndpointValueObjectProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwitchpointsPutRequestEndpointValueObjectProperties(val *SwitchpointsPutRequestEndpointValueObjectProperties) *NullableSwitchpointsPutRequestEndpointValueObjectProperties {
	return &NullableSwitchpointsPutRequestEndpointValueObjectProperties{value: val, isSet: true}
}

func (v NullableSwitchpointsPutRequestEndpointValueObjectProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwitchpointsPutRequestEndpointValueObjectProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
