...
// checks if the ConfigPutRequestCommunityListCommunityListNameListsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigPutRequestCommunityListCommunityListNameListsInner{}

// ConfigPutRequestCommunityListCommunityListNameListsInner struct for ConfigPutRequestCommunityListCommunityListNameListsInner
type ConfigPutRequestCommunityListCommunityListNameListsInner struct {
...
func NewConfigPutRequestCommunityListCommunityListNameListsInner() *ConfigPutRequestCommunityListCommunityListNameListsInner {
	this := ConfigPutRequestCommunityListCommunityListNameListsInner{}
...
func (o ConfigPutRequestCommunityListCommunityListNameListsInner) MarshalJSON() ([]byte, error) {
...
func (o ConfigPutRequestCommunityListCommunityListNameListsInner) ToMap() (map[string]interface{}, error) {
...
type NullableConfigPutRequestCommunityListCommunityListNameListsInner struct {
	value *ConfigPutRequestCommunityListCommunityListNameListsInner
	isSet bool
}

func (v NullableConfigPutRequestCommunityListCommunityListNameListsInner) Get() *ConfigPutRequestCommunityListCommunityListNameListsInner {
	return v.value
}

func (v *NullableConfigPutRequestCommunityListCommunityListNameListsInner) Set(val *ConfigPutRequestCommunityListCommunityListNameListsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigPutRequestCommunityListCommunityListNameListsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigPutRequestCommunityListCommunityListNameListsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigPutRequestCommunityListCommunityListNameListsInner(val *ConfigPutRequestCommunityListCommunityListNameListsInner) *NullableConfigPutRequestCommunityListCommunityListNameListsInner {
	return &NullableConfigPutRequestCommunityListCommunityListNameListsInner{value: val, isSet: true}
}

func (v NullableConfigPutRequestCommunityListCommunityListNameListsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigPutRequestCommunityListCommunityListNameListsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
