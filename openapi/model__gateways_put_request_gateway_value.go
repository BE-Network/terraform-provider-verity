...
// checks if the GatewaysPutRequestGatewayValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewaysPutRequestGatewayValue{}
...
func (o *GatewaysPutRequestGatewayValue) GetStaticRoutes() []GatewaysPutRequestGatewayValueStaticRoutesInner {
	if o == nil || IsNil(o.StaticRoutes) {
		var ret []GatewaysPutRequestGatewayValueStaticRoutesInner
		return ret
	}
...
// SetStaticRoutes gets a reference to the given []GatewaysPutRequestGatewayValueStaticRoutesInner and assigns it to the StaticRoutes field.
...
type NullableGatewaysPutRequestGatewayValue struct {
	value *GatewaysPutRequestGatewayValue
	isSet bool
}

func (v NullableGatewaysPutRequestGatewayValue) Get() *GatewaysPutRequestGatewayValue {
	return v.value
}

func (v *NullableGatewaysPutRequestGatewayValue) Set(val *GatewaysPutRequestGatewayValue) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewaysPutRequestGatewayValue) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewaysPutRequestGatewayValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewaysPutRequestGatewayValue(val *GatewaysPutRequestGatewayValue) *NullableGatewaysPutRequestGatewayValue {
	return &NullableGatewaysPutRequestGatewayValue{value: val, isSet: true}
}

func (v NullableGatewaysPutRequestGatewayValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewaysPutRequestGatewayValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
