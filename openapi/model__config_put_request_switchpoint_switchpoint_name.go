...
// checks if the ConfigPutRequestSwitchpointSwitchpointName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigPutRequestSwitchpointSwitchpointName{}

// ConfigPutRequestSwitchpointSwitchpointName struct for ConfigPutRequestSwitchpointSwitchpointName
type ConfigPutRequestSwitchpointSwitchpointName struct {
	...
	Eths []ConfigPutRequestSwitchpointSwitchpointNameEthsInner `json:"eths,omitempty"`
...
func NewConfigPutRequestSwitchpointSwitchpointName() *ConfigPutRequestSwitchpointSwitchpointName {
	this := ConfigPutRequestSwitchpointSwitchpointName{}
	var name string = ""
	this.Name = &name
...
func (o *ConfigPutRequestSwitchpointSwitchpointName) GetEths() []ConfigPutRequestSwitchpointSwitchpointNameEthsInner {
	if o == nil || IsNil(o.Eths) {
		var ret []ConfigPutRequestSwitchpointSwitchpointNameEthsInner
		return ret
	}
	return o.Eths
}
...
// SetEths gets a reference to the given []ConfigPutRequestSwitchpointSwitchpointNameEthsInner and assigns it to the Eths field.
...
func (o ConfigPutRequestSwitchpointSwitchpointName) MarshalJSON() ([]byte, error) {
...
func (o ConfigPutRequestSwitchpointSwitchpointName) ToMap() (map[string]interface{}, error) {
...
type NullableConfigPutRequestSwitchpointSwitchpointName struct {
	value *ConfigPutRequestSwitchpointSwitchpointName
	isSet bool
}

func (v NullableConfigPutRequestSwitchpointSwitchpointName) Get() *ConfigPutRequestSwitchpointSwitchpointName {
	return v.value
}

func (v *NullableConfigPutRequestSwitchpointSwitchpointName) Set(val *ConfigPutRequestSwitchpointSwitchpointName) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigPutRequestSwitchpointSwitchpointName) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigPutRequestSwitchpointSwitchpointName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigPutRequestSwitchpointSwitchpointName(val *ConfigPutRequestSwitchpointSwitchpointName) *NullableConfigPutRequestSwitchpointSwitchpointName {
	return &NullableConfigPutRequestSwitchpointSwitchpointName{value: val, isSet: true}
}

func (v NullableConfigPutRequestSwitchpointSwitchpointName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigPutRequestSwitchpointSwitchpointName) UnmarshalJSON(src []byte) error {
	v.isSet = true
