...
**ExternalBatteryPowerAvailable** | Pointer to **int32** | External Battery Power Available | [optional] 
**ExternalPowerAvailable** | Pointer to **int32** | External Power Available | [optional] 
**SecurityAuditInterval** | Pointer to **NullableInt32** | Frequency in minutes of rereading this Switch running configuration and comparing it to expected values.                                                 &lt;br&gt;if the value is blank, audit will use default switch settings.                                                 &lt;br&gt;if the value is 0, audit will be turned off.                                                  | [optional] 
**CommitToFlashInterval** | Pointer to **NullableInt32** | Frequency in minutes to write the Switch configuration to flash.                                                 &lt;br&gt;if the value is blank, commit will use default switch settings.                                                 &lt;br&gt;if the value is 0, commit will be turned off. | [optional] 
