...
------------ | ------------- | ------------- | -------------
**BandwidthForQueue** | Pointer to **NullableInt64** | Percentage bandwidth allocated to Queue. 0 is no limit | [optional] [default to 0]
**SchedulerType** | Pointer to **string** | Scheduler Type for Queue | [optional] [default to "SP"]
**SchedulerWeight** | Pointer to **NullableInt64** | Weight associated with WRR or DWRR scheduler | [optional] [default to 0]
