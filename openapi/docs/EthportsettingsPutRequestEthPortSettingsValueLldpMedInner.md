...
**LldpMedRowNumDscpMark** | Pointer to **NullableInt64** | Defines egress LLDP sent when a device is connected to this Eth-Port Settings allowing the device to auto-provision its DSCP marking. | [optional] [default to 0]
