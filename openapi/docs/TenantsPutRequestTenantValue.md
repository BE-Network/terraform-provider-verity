...
**DhcpRelaySourceIpv4sSubnet** | Pointer to **string** | IPv4 subnet used to allocate Tenant-specific loopback addresses on each leaf switch for DHCP relay and troubleshooting. | [optional] [default to ""]
**DhcpRelaySourceIpv6sSubnet** | Pointer to **string** | IPv6 subnet used to allocate Tenant-specific loopback addresses on each leaf switch for DHCP relay and troubleshooting. | [optional] [default to ""]
...
**RouteAggregation** | Pointer to **string** | Route Aggregation configuration for this tenant | [optional] [default to ""]
