...
// checks if the MacfiltersPutRequestMacFilterValueFiltersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MacfiltersPutRequestMacFilterValueFiltersInner{}
...
type NullableMacfiltersPutRequestMacFilterValueFiltersInner struct {
	value *MacfiltersPutRequestMacFilterValueFiltersInner
	isSet bool
}

func (v NullableMacfiltersPutRequestMacFilterValueFiltersInner) Get() *MacfiltersPutRequestMacFilterValueFiltersInner {
	return v.value
}

func (v *NullableMacfiltersPutRequestMacFilterValueFiltersInner) Set(val *MacfiltersPutRequestMacFilterValueFiltersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMacfiltersPutRequestMacFilterValueFiltersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMacfiltersPutRequestMacFilterValueFiltersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMacfiltersPutRequestMacFilterValueFiltersInner(val *MacfiltersPutRequestMacFilterValueFiltersInner) *NullableMacfiltersPutRequestMacFilterValueFiltersInner {
	return &NullableMacfiltersPutRequestMacFilterValueFiltersInner{value: val, isSet: true}
}

func (v NullableMacfiltersPutRequestMacFilterValueFiltersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMacfiltersPutRequestMacFilterValueFiltersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
