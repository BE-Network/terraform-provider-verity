...
// checks if the LagsPutRequestLagValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LagsPutRequestLagValue{}
...
type NullableLagsPutRequestLagValue struct {
	value *LagsPutRequestLagValue
	isSet bool
}

func (v NullableLagsPutRequestLagValue) Get() *LagsPutRequestLagValue {
	return v.value
}

func (v *NullableLagsPutRequestLagValue) Set(val *LagsPutRequestLagValue) {
	v.value = val
	v.isSet = true
}

func (v NullableLagsPutRequestLagValue) IsSet() bool {
	return v.isSet
}

func (v *NullableLagsPutRequestLagValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLagsPutRequestLagValue(val *LagsPutRequestLagValue) *NullableLagsPutRequestLagValue {
	return &NullableLagsPutRequestLagValue{value: val, isSet: true}
}

func (v NullableLagsPutRequestLagValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLagsPutRequestLagValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
