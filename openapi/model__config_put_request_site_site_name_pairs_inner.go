...
// checks if the ConfigPutRequestSiteSiteNamePairsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigPutRequestSiteSiteNamePairsInner{}

// ConfigPutRequestSiteSiteNamePairsInner struct for ConfigPutRequestSiteSiteNamePairsInner
...
func NewConfigPutRequestSiteSiteNamePairsInner() *ConfigPutRequestSiteSiteNamePairsInner {
	this := ConfigPutRequestSiteSiteNamePairsInner{}
	var name string = ""
	this.Name = &name
...
func (o ConfigPutRequestSiteSiteNamePairsInner) MarshalJSON() ([]byte, error) {
...
func (o ConfigPutRequestSiteSiteNamePairsInner) ToMap() (map[string]interface{}, error) {
...
type NullableConfigPutRequestSiteSiteNamePairsInner struct {
	value *ConfigPutRequestSiteSiteNamePairsInner
	isSet bool
}

func (v NullableConfigPutRequestSiteSiteNamePairsInner) Get() *ConfigPutRequestSiteSiteNamePairsInner {
	return v.value
}

func (v *NullableConfigPutRequestSiteSiteNamePairsInner) Set(val *ConfigPutRequestSiteSiteNamePairsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigPutRequestSiteSiteNamePairsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigPutRequestSiteSiteNamePairsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigPutRequestSiteSiteNamePairsInner(val *ConfigPutRequestSiteSiteNamePairsInner) *NullableConfigPutRequestSiteSiteNamePairsInner {
	return &NullableConfigPutRequestSiteSiteNamePairsInner{value: val, isSet: true}
}

func (v NullableConfigPutRequestSiteSiteNamePairsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigPutRequestSiteSiteNamePairsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
