...
// checks if the ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName{}

// ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName struct for ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName
type ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName struct {
	...
	EthPorts []ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameEthPortsInner `json:"eth_ports,omitempty"`
	ObjectProperties *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameObjectProperties `json:"object_properties,omitempty"`
}
...
func NewConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName() *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName {
	this := ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName{}
	var name string = ""
	this.Name = &name
...
func (o *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) GetEthPorts() []ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameEthPortsInner {
	if o == nil || IsNil(o.EthPorts) {
		var ret []ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameEthPortsInner
		return ret
	}
	return o.EthPorts
}
...
// SetEthPorts gets a reference to the given []ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameEthPortsInner and assigns it to the EthPorts field.
...
func (o *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) GetObjectProperties() ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameObjectProperties {
	if o == nil || IsNil(o.ObjectProperties) {
		var ret ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameObjectProperties
		return ret
	}
...
// SetObjectProperties gets a reference to the given ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortNameObjectProperties and assigns it to the ObjectProperties field.
...
func (o ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) MarshalJSON() ([]byte, error) {
...
func (o ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) ToMap() (map[string]interface{}, error) {
...
type NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName struct {
	value *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName
	isSet bool
}

func (v NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) Get() *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName {
	return v.value
}

func (v *NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) Set(val *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName(val *ConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) *NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName {
	return &NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName{value: val, isSet: true}
}

func (v NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigPutRequestAuthenticatedEthPortAuthenticatedEthPortName) UnmarshalJSON(src []byte) error {
	v.isSet = true
